...
<head>
  ...
  <style>
	...
	{
		background: linear-gradient(90deg, rgba(2,0,36,1) 25%, rgba(9,9,121,0.3533788515406162) 50%, rgba(0,212,255,1) 75%);
	}
	</style>
  <!-- Google Font -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Antibribery</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="https://static.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_200x200_v1.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="https://static.licdn.com/scds/common/u/images/themes/katy/ghosts/person/ghost_person_200x200_v1.png" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Tender</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('tender/tender_insert'); ?>"><i class="fa fa-circle-o"></i> Add Tender</a></li>
            <li><a href="<?php echo base_url('tender/display_tender'); ?>"><i class="fa fa-circle-o"></i> Manage Tender</a></li>
          </ul>
        </li>
		<li class=" treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Tender Tracking</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('tender/tender_info'); ?>"><i class="fa fa-circle-o"></i>Tender Information</a></li>
            <li><a href="<?php echo base_url('tender/tender_tracker'); ?>"><i class="fa fa-circle-o"></i>Tracking</a></li>
          </ul>
        </li>
        <li>
      </ul>
